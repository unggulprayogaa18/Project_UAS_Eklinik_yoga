...
import 'package:e_klinik_dr_h_m_chalim/screens/screen_admin/profile_admin.dart';
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            // Handle onTap for Container adminadataregistrasi1
                            Get.offNamed('/load');
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Container 1 for "Janji hari ini"
                  GestureDetector(
                    onTap: () async {
                      Get.offNamed('/load');
                      await Future.delayed(Duration(seconds: 2));
                      Get.offNamed('/jadwalcheckup');
                    },
                    child: buildArticleContainer(
                      'Janji hari ini',
                      'Lihat detail janji',
