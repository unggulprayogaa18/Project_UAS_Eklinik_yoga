        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              buildButton('Logout', const Color.fromARGB(255, 40, 84, 121),
                  Colors.white, const Color.fromARGB(255, 14, 66, 109)),
            ],
          ),
        ),
      ),
    ...
    return ListTile(
      ...
      title: Text(
        ...
        style: TextStyle(
          ...
          fontSize: 13,
          color:
              const Color.fromARGB(255, 13, 99, 170), // Set text color to blue
        ),
      ),
      subtitle: Text(
        value,
      ...
      child: TextButton(
        onPressed: () async {
          ...
          if (text == 'Edit Profile') {
            ...
            Get.offNamed('/editprofileApoteker');
          } else if (text == 'Logout') {
            // Handle logout
            await Get.toNamed('/load');
