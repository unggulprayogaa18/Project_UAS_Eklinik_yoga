...
import 'package:e_klinik_dr_h_m_chalim/screens/screen_apoteker/profile_apoteker.dart';
                        ...
                        child: GestureDetector(
                          onTap: () {
                            ...
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ListResepPasien()),
                            );
                          },
                          child: Column(
                            children: [
                              Container(
                                ...
                                child: Image.asset(
                                  'assets/icon2/clinical1.png', // Replace with your image asset
                                  fit: BoxFit.contain,
                                ),
                              ),
                              SizedBox(height: 8),
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ProfileApoteker()),
                          );
                        },
                        child: Column(
                          children: [
