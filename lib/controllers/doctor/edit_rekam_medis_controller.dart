...
class EditRekamMedisController extends GetxController {
  ...
  void fetchDataAndSaveToFirestore(
    ...
    try {
      ...
      if (nomerRekamMedis != null) {
        // Ambil data nama dari database berdasarkan nomor rekam medis
        ...
        if (eklinikSnapshot.docs.isNotEmpty) {
          ...
          // Update dokumen yang sudah ada dengan data yang diberikan
          await FirebaseFirestore.instance
            ...
            'keluhan': keluhan,
            'tanggal_medis':
                tanggalMedis, // Tanggal medis sesuai format "yyyy-MM-dd"
          });
